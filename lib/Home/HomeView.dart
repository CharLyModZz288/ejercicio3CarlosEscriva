...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("EjercicioCarlosEscriva"),
      ...
      try {
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  Text('Temperatura actualmente : $temperatura'),
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text('Error'),
              content: Text('Fallo para conseguir la temperatura'),
              actions: [
                TextButton(
                  child: Text('Aceptar'),
                  onPressed: () {
            ...
            content: Column(
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(labelText: 'Que pokémon quieres'),
                ),
              ],
            ),
            actions: [
